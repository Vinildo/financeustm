            ...
            <div className="space-y-4">
              ...
              <Table>
                <TableHeader className="bg-red-700">
                  <TableRow>
                    <TableHead className="text-white font-bold">Referência</TableHead>
                    ...
                    <TableHead className="text-white font-bold">Departamento</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {fornecedorAtual.pagamentos.map((pagamento, index) => (
                    <TableRow key={pagamento.id} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
